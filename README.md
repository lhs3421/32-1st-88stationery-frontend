...
<img src="https://im.ezgif.com/tmp/ezgif-1-503870fc1d.gif" />

- OnBlur이벤트를 적용해서 아무것도 입력되지 않을시 밑에 텍스트가 나오게 함 
- 각각의 값이 검증에 실패할시 밑에 텍스트가 나오게 함
- 각각의 입력된값이 모두 검증에 성공할시만 가입하기 버튼이 활성화 되도록함 


## 장바구니 

<img src="https://im.ezgif.com/tmp/ezgif-1-997586c8ff.gif" />
                                                                  
- 수량변경시 값이 전체 값이 변경 되도록함 
- 수량을 0미만으로는 못줄이게 설정 
- 3만원 이상 구매시 배송비가 적용안되게 함 

## 마이페이지

<img width="1157" alt="스크린샷 2022-05-08 오후 4 54 35" src="https://user-images.githubusercontent.com/95524491/167287045-4ba28f86-3e35-4b5d-a50e-4148c0bbd6ca.png">

- 백에서 받아온 데이터를 화면에 그려줌
